...
builder.Services.AddScoped(sp => new HttpClient { BaseAddress = new Uri("https://localhost:7240/") }); //<-- por aqui se conecta al web, se coloca la ip de la api para conectar los proyectos
