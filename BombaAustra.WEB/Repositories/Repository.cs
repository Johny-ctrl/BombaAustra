...

{
    ...
    {
        private readonly HttpClient _httpClient; //<-- Inyectando el HttpClient

        private JsonSerializerOptions _jsonDefaultOptions => new JsonSerializerOptions //Traduce todo para evitar problemas de mayus
        {
